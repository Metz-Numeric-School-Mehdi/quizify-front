        ...
        <div class="flex items-center gap-6">
          ...
          <div class="flex-1">
            <h3
              ...
              :class="isPassed ? 'text-green-700' : 'text-red-700'"
            >
            ...
            <div class="flex items-center gap-4">
              <div class="flex items-baseline gap-1">
                ...
                <span class="text-xl text-gray-700">{{ totalQuestions }}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
        ...
        <ul class="space-y-3">
          <li class="flex justify-between items-center">
            ...
            <span class="font-semibold text-green-600">{{ score }}</span>
          </li>
          <li class="flex justify-between items-center">
            <span class="text-gray-600">Mauvaises réponses :</span>
            <span class="font-semibold text-red-600">{{ totalQuestions - score }}</span>
          </li>
          <li class="flex justify-between items-center">
...
const { score, totalQuestions, passScore } = defineProps<{
  score: number;
