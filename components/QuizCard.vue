<template>
  <div
    ...
    <img v-else class="w-full h-32 sm:h-36 object-cover" src="@/assets/img/card_wallp.jpeg" alt="Quiz Image" />
...
const { title, duration, img } = defineProps<{ title: string, duration: number, img: string }>()
</script>
