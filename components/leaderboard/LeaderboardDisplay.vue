<template>
  <div class="flex flex-col gap-4 relative">
    ...
    <div class="flex justify-between items-center mb-4 z-10">
      <h1 class="text-[2rem] font-bold text-pink-600">Classement</h1>
    </div>
...
const fetchLeaderboard = (page = 1) => {
  if (props.categoryId) {
    leaderboardStore.getLeaderboardByCategory(props.categoryId, page);
  } else if (props.organizationId) {
    leaderboardStore.getLeaderboardByOrganization(props.organizationId, page);
  } else {
    leaderboardStore.getGlobalLeaderboard(page);
  }
};
